...
public final class ItemArticleBinding implements ViewBinding {
  ...
  private ItemArticleBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView articleImg,
  ...
  public static ItemArticleBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.articleImg;
      ImageView articleImg = rootView.findViewById(id);
      if (articleImg == null) {
        break missingId;
      }
      ...
      return new ItemArticleBinding((ConstraintLayout) rootView, articleImg, articleTitle);
    }
